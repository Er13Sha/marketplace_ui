...
import { catalogApi, uploadToPresignedUrl } from "@/features/catalog/infrastructure/catalog-api";
import {
  MAX_PRODUCT_IMAGES,
  MAX_PRODUCT_IMAGE_SIZE,
  PRODUCT_IMAGE_TYPES,
  type PendingProductImage,
} from "@/features/catalog/presentation/product-image-picker";
import {
  initialProductForm,
...
export function useSellerCabinet() {
  ...
  const submitProduct = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      let imagePayload: Pick<import("@/features/catalog/domain/product").CreateProductPayload, "imageUploadSessionId" | "images"> = {};
